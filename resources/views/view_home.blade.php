...
@section('isihalaman')
    ...
    <p>
    <h4>Perpustakaan LiterasiLestari</h4>
        UPT Perpustakaan  sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia 
		selama ini juga telah melaksanakan kelima tugas tersebut dalam kegiatan di perpustakaannya untuk mendukung 
		terwujudnya Tri Dharma Perguruan Tinggi. Berbagai upaya dilakukan oleh Perpustakaan, LiterasiLestari sendiri berada 
		ditempat yang cukup representative, mudah diakses baik oleh mahasiswa ataupun kalangan civitas akademika. 
		Disamping itu juga memiliki ribuan koleksi mulai dari Buku, Jurnal, Majalah, Dokumen Penelitian dan berbagai sumber 
		referensi lain guna menunjang proses pembelajaran.

    <p>
        Perhatian pimpinan LiterasiLestari dalam pengembangan dan peningkatan layanan Perpustakaan semakin 
		membaik 5 tahun belakangan ini, hal ini ditunjukan dengan koleksi bahan perpustakaan yang meningkat cukup baik 
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. LiterasiLestari sampai 10 Oktober 2023
